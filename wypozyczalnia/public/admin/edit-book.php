...
<head>
    ...
    <title>MID-CONTINENT Public Library | Edit Book</title>
...
<input class="form-control" type="text" name="bookname" value="<?php
...
<option value="<?php
            echo htmlentities($result->cid);
?>"> <?php
            echo htmlentities($catname = $result->CategoryName);
?></option>
<?php
            $status = 1;
...
<option value="<?php
            echo htmlentities($result->athrid);
?>"> <?php
            echo htmlentities($athrname = $result->AuthorName);
?></option>
<?php
...
?>  
<option value="<?php
                        echo htmlentities($ret->id);
?>"><?php
                        echo htmlentities($ret->AuthorName);
?></option>
 <?php
                    }
                }
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="price" value="<?php
            echo htmlentities($result->BookPrice);
?>"   required="required" />
 </div>
 <?php
        }
